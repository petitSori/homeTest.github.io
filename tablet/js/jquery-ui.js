				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							( unselectable ? "<a href='javascript:void(0)' data-month='" + printDate.getMonth() + "' data-year='" + printDate.getFullYear() + "' class='ui-state-default unselectable-link'>" + printDate.getDate() + "</a>" : "<a class='ui-state-default" +
